 ...
 * @author Elte Hupkes
 */
package com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.matcher;

import android.util.Log;

import com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.Parameters;
import com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.PlaybackAnalyzer;
import com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.PlaybackAnalyzer.Status;
import com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.RunningAverage;
import com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.feature.FrameVector;
import com.ScoreFollowerLibrary.nl.metaphoric.scorefollower.lib.file.ScoreReader.FileSettings;
...
public class PositionMatcher {
	 ...
	 * reference data.
	 */
	public PositionMatcher(Vector<FrameVector> ref, double w, double h) {
		windowSize = w;
		hopSize = h;
		reference = ref;
	...
	private void getTransitions(int l, FrameVector v, int start, int end, double[] transitions) {
		...
		for (int i = start; i < end; i++) {
            ...
            Log.e(TAG, "Probability : " + String.valueOf(transitions[i - start]));
        }
	}
