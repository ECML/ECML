 ...
 * @author Nicolas
 *
 * The Volume Listener is used to detect when the volume is muted so that
 * the mute image can be updated when needed. It is also used to remember
...
public class VolumeListener extends ContentObserver {
     ...
     * @param player The MidiPlayer to handle
     */
